...
<style>
  ...
  .pr-stat:hover {
    box-shadow: 0 6px 20px rgba(59, 111, 245, .1);
  ...
  button.btn-primary-pr:hover {
    background: #2859e0 !important;
  }

  button.btn-primary-pr:active {
    transform: scale(.96);
  }
  ...
  #pr-toast.success .t-ico {
    background: #dcfce7;
  }

  #pr-toast.error .t-ico {
    background: #fee2e2;
  }
  ...
  .pr-overlay.shown .pr-modal {
    transform: scale(1) translateY(0);
    opacity: 1;
  }

  .pr-overlay.closing .pr-modal {
  ...
  button.btn-add-bahan {
    ...
    border: 1.5px dashed #c7d7fc !important;
  ...
  button.btn-ms-pr.green {
    background: #16a34a !important;
  }

  button.btn-ms-pr.green:hover {
    background: #138638 !important;
  }

  button.btn-ms-pr:active {
    transform: scale(.96);
  }

  button.btn-ms-pr:disabled {
    opacity: .6;
    cursor: not-allowed;
  }
...
<!-- Toast -->
<div id="pr-toast">
  <div class="t-ico" id="pr-t-ico"></div><span id="pr-t-msg"></span>
</div>
...
<div class="pr-overlay" id="modal-produksi">
  <div class="pr-modal">
    <div class="m-head">
      <div class="m-ico ic-g"><i class="bi bi-gear-fill"></i></div>
      <div>
    ...
    <div style="margin-bottom:14px">
      <div class="bahan-list-header">
        <div class="bahan-list-title"><i class="bi bi-basket2-fill" style="color:var(--accent)"></i> Bahan Baku yang
          Digunakan</div>
        <span id="bahan-stok-warn" style="font-size:.72rem;color:var(--amber);display:none"><i
            class="bi bi-exclamation-triangle-fill"></i> Periksa stok bahan</span>
      </div>
...
<div class="pr-wrap">
  <div class="pr-header">
    <div>
      <h1 class="pr-title"><i class="bi bi-gear-fill" style="color:var(--accent); margin-right:8px"></i> Produksi</h1>
  ...
  <div class="pr-stats">
    <div class="pr-stat">
      <div class="stat-ico ic-b"><i class="bi bi-clipboard2-check-fill"></i></div>
      <div class="stat-val tb" id="s-total">—</div>
      <div class="stat-lbl">Total Produksi</div>
    </div>
    <div class="pr-stat">
      <div class="stat-ico ic-g"><i class="bi bi-check-circle-fill"></i></div>
      <div class="stat-val tg" id="s-selesai">—</div>
      <div class="stat-lbl">Selesai</div>
    </div>
    <div class="pr-stat">
      <div class="stat-ico ic-a"><i class="bi bi-calendar-check-fill"></i></div>
      <div class="stat-val ta" id="s-bulan">—</div>
      <div class="stat-lbl">Bulan Ini</div>
    </div>
    <div class="pr-stat">
      <div class="stat-ico ic-r"><i class="bi bi-x-circle-fill"></i></div>
      <div class="stat-val" style="color:var(--red)" id="s-batal">—</div>
  ...
  <div class="pr-card">
    <div class="pr-card-head">
      <div class="pr-card-title"><i class="bi bi-clipboard2-data-fill" style="color:var(--accent)"></i> Riwayat Produksi
      </div>
