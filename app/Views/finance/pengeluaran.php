...
.stat-card { background:#fff; border:1px solid var(--border); border-radius:14px; padding:20px; position:relative; overflow:hidden; transition:border-color .2s, transform .2s; box-shadow:0 1px 3px rgba(0,0,0,.05); text-align:center; }
...
.stat-card .stat-value { font-size:2.2rem; font-weight:800; color:var(--accent); line-height:1; margin-bottom:8px; margin-top:8px; }
.stat-card .stat-label { font-size:.8rem; color:var(--text-muted); text-transform:uppercase; letter-spacing:.05em; font-weight:600; }
...
.sim-select, .sim-input { width:100%; background:#fff; border:1px solid var(--border); color:var(--text-main); border-radius:8px; padding:8px 12px; font-size:.8rem; outline:none; transition:border-color .15s; margin-bottom:12px; }
.sim-select:focus, .sim-input:focus { border-color:var(--accent); box-shadow:0 0 0 3px rgba(59,130,246,.1); }
.sim-select:disabled, .sim-input[readonly] { background:#f8fafc; color:var(--text-muted); cursor:not-allowed; }
...
.alert-sim { padding:12px 16px; border-radius:8px; margin-bottom:20px; display:flex; align-items:center; gap:10px; font-size:.85rem; font-weight:500; }
.alert-sim-success { background:rgba(16,185,129,.08); border:1px solid rgba(16,185,129,.25); color:#059669; }
.alert-sim-danger  { background:rgba(239,68,68,.08);  border:1px solid rgba(239,68,68,.25);  color:#dc2626; }
      ...
      <table class="sim-table">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div style="font-weight: 600; color: var(--text-main); font-size: 0.8rem;"><?= $t['kategori'] ?></div>
              <div style="font-size: 0.72rem; color: var(--text-muted); mt-1"><?= $t['keterangan'] ?></div>
            </td>
            <td style="text-align: right; font-weight: bold; font-family: monospace; font-size: 1em; color: var(--text-main);">
