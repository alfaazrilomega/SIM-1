...
.page-subtitle { font-size: .8rem; color: var(--text-2); margin-top: 3px; }
...
.ic-red    { background: rgba(220,38,38,.1);  color: #dc2626; }

.stat-body {}
.stat-val   { font-size: 1.5rem; font-weight: 800; color: var(--text-1); letter-spacing: -.03em; line-height: 1; }
.stat-label { font-size: .72rem; color: var(--text-2); margin-top: 3px; font-weight: 500; text-transform: uppercase; letter-spacing: .05em; }
...
.search-wrap .sim-input { padding-left: 32px; }
.sim-input:focus, .sim-select:focus { border-color: var(--accent); background: #fff; }
.sim-select { width: auto; cursor: pointer; }

.toolbar-divider { width: 1px; height: 26px; background: var(--border-md); flex-shrink: 0; }
...
.content-label { font-size: .82rem; color: var(--text-2); font-weight: 500; }
...
.product-grid.list-view .product-card { flex-direction: row; align-items: center; padding: 14px 18px; }
.product-grid.list-view .product-card-top { display: flex; align-items: center; gap: 12px; flex: 1; }
.product-grid.list-view .product-card-emoji { margin-bottom: 0; flex-shrink: 0; }
.product-grid.list-view .product-card-stok-block { text-align: right; flex-shrink: 0; min-width: 80px; }
.product-grid.list-view .product-card-divider,
.product-grid.list-view .product-card-info { display: none; }
.product-grid.list-view .product-card-actions { margin-top: 0; margin-left: 12px; flex-shrink: 0; }
...
.product-card:hover { transform: translateY(-3px); border-color: rgba(37,99,235,.2); box-shadow: var(--shadow-md); }
.product-card.stok-habis  { border-color: rgba(220,38,38,.2); background: #fff8f8; }
.product-card.stok-nipis  { border-color: rgba(217,119,6,.2); background: #fffdf5; }
...
.product-card-sku  { font-family: var(--ff-mono); font-size: .68rem; color: var(--text-3); margin-bottom: 3px; font-weight: 600; }
.product-card-name { font-size: .9rem; font-weight: 700; color: var(--text-1); line-height: 1.35; margin-bottom: 12px; }

.product-card-stok-block { margin-bottom: 2px; }
.product-card-stok { font-size: 2.1rem; font-weight: 800; line-height: 1; letter-spacing: -2px; }
.product-card-stok-sub { font-size: .68rem; color: var(--text-3); text-transform: uppercase; letter-spacing: 1px; margin-top: 2px; display: flex; align-items: center; gap: 6px; }

.product-card-divider { height: 1px; background: var(--border); margin: 12px 0; }
.product-card-info { display: flex; justify-content: space-between; }
.pc-info-item { display: flex; flex-direction: column; gap: 2px; }
.pc-info-label { font-size: .63rem; color: var(--text-3); text-transform: uppercase; letter-spacing: .7px; font-weight: 600; }
.pc-info-val { font-size: .82rem; font-weight: 700; }
...
.btn-card-blue  { background: rgba(37,99,235,.08);  color: #2563eb; border: 1px solid rgba(37,99,235,.18); }
.btn-card-blue:hover  { background: rgba(37,99,235,.14); }
.btn-card-gray  { background: rgba(100,116,139,.08); color: #64748b; border: 1px solid rgba(100,116,139,.18); }
.btn-card-gray:hover  { background: rgba(100,116,139,.15); }
.btn-card-purple { background: rgba(124,58,237,.08); color: #7c3aed; border: 1px solid rgba(124,58,237,.18); }
.btn-card-purple:hover { background: rgba(124,58,237,.14); }
...
.sim-table thead th.tr { text-align: right; }
.sim-table tbody tr { border-bottom: 1px solid var(--border); transition: background .12s; }
.sim-table tbody tr:last-child { border-bottom: none; }
.sim-table tbody tr:hover { background: #f8fafc; }
.sim-table tbody td { padding: 11px 16px; color: var(--text-1); vertical-align: middle; white-space: nowrap; }
.sim-table tbody td.tr { text-align: right; }
...
.badge-success { background: rgba(5,150,105,.1); color: #047857; border: 1px solid rgba(5,150,105,.2); }
...
.badge-in      { background: rgba(5,150,105,.1);  color: #047857; border: 1px solid rgba(5,150,105,.2); }
.badge-out     { background: rgba(220,38,38,.1);  color: #b91c1c; border: 1px solid rgba(220,38,38,.2); }
...
.btn-ghost:hover { border-color: rgba(37,99,235,.4); color: var(--accent); background: rgba(37,99,235,.04); }
.btn-ghost.purple:hover { border-color: rgba(124,58,237,.4); color: #7c3aed; background: rgba(124,58,237,.04); }
.btn-ghost.red:hover   { border-color: rgba(220,38,38,.4); color: #dc2626; background: rgba(220,38,38,.04); }
...
.modal-title { font-size: 1rem; font-weight: 800; color: var(--text-1); letter-spacing: -.02em; }
.modal-subtitle { font-size: .78rem; color: var(--text-2); margin-top: 3px; }
...
.form-control:focus { border-color: var(--accent); background: #fff; box-shadow: 0 0 0 3px rgba(37,99,235,.08); }
.form-control[readonly] { cursor: default; color: var(--text-2); }
.form-hint { font-size: .7rem; color: var(--text-3); margin-top: 2px; }
.modal-footer {
...
.btn-cancel:hover { background: #f1f5f9; color: var(--text-1); }
.btn-submit {
  flex: 2; padding: 10px;
  border-radius: var(--radius-sm);
  border: none; color: #fff;
  font-size: .82rem; cursor: pointer; font-weight: 700;
  transition: opacity .15s; font-family: var(--ff-body);
  display: flex; align-items: center; justify-content: center; gap: 6px;
}
.btn-submit:hover { opacity: .88; }
.btn-submit.grad-blue  { background: linear-gradient(135deg, #2563eb, #7c3aed); box-shadow: 0 3px 10px rgba(37,99,235,.3); }
.btn-submit.grad-red   { background: linear-gradient(135deg, #dc2626, #b91c1c); box-shadow: 0 3px 10px rgba(220,38,38,.3); }
...
.riwayat-table-wrap .sim-table tbody td { white-space: normal; }
...
.stok-display-label { font-size: .72rem; color: var(--text-2); font-weight: 600; text-transform: uppercase; letter-spacing: .05em; }
.stok-display-val   { font-size: 1.25rem; font-weight: 800; letter-spacing: -.02em; }
...
#toast.success { background: #fff; border: 1px solid rgba(5,150,105,.3); color: #047857; }
#toast.error   { background: #fff; border: 1px solid rgba(220,38,38,.3); color: #dc2626; }
...
<div class="modal-overlay" id="modal-hapus">
  <div class="modal-box" style="max-width:380px">
    ...
    <div style="background:#fff5f5;border:1px solid rgba(220,38,38,.2);border-radius:var(--radius-sm);padding:14px 16px;margin-bottom:4px">
      <div style="font-size:.72rem;color:var(--text-2);text-transform:uppercase;letter-spacing:.06em;font-weight:700">Produk yang akan dihapus:</div>
...
<div class="modal-overlay" id="modal-riwayat">
  <div class="modal-box" style="max-width:580px">
    ...
    <div class="modal-footer" style="margin-top:16px">
      <button class="btn-cancel" onclick="closeModal('modal-riwayat')" style="flex:none;padding:10px 28px">Tutup</button>
    </div>
  </div>
</div>
...
<div class="stat-grid">
  <div class="stat-card blue">
    <div class="stat-icon ic-blue"><i class="bi bi-jar-fill"></i></div>
    <div class="stat-body">
...
function renderCards(list) {
  ...
  if (!list.length) {
    grid.innerHTML = `<div class="empty-state" style="grid-column:1/-1"><i class="bi bi-jar"></i><p>Tidak ada produk yang cocok dengan filter.</p></div>`;
    return;
  }
  ...
  grid.innerHTML = list.map(r => {
    ...
    return `<div class="product-card ${s.cardClass}">
      <div class="product-card-top">
        <div class="product-card-emoji">🫙</div>
...
function renderTabel(list) {
  ...
  if (!list.length) {
    tbody.innerHTML = `<tr><td colspan="9"><div class="empty-state"><i class="bi bi-jar"></i><p>Tidak ada produk yang cocok.</p></div></td></tr>`;
    return;
  }
